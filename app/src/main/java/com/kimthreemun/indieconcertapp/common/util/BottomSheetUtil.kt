...
fun Fragment.showOptionBottomSheet(
    ...
    val view = LayoutInflater.from(requireContext()).inflate(R.layout.bottom_sheet_options_flexbox, null)
    ...
    options.forEach { option ->
        val chip = TextView(requireContext()).apply {
            ...
            background = ContextCompat.getDrawable(
                requireContext(),
                if (selectedSet.contains(option)) R.drawable.bg_chip_selected else R.drawable.bg_chip_unselected
            )
